...
data class VetAppointmentListItem(
...
) : ListAdapter<VetAppointmentListItem, VetAppointmentAdapter.ViewHolder>(
    VetDiffCallback()
) {
    ...
    inner class ViewHolder(
        ...
        fun bind(item: VetAppointmentListItem) {
            ...
            binding.tvApptTimeProvider.text =
                "${formatTime(appt.time)} · ${appt.clinicName}"
            ...
            return try {
                ...
                val appointmentCalendar =
                    Calendar.getInstance().apply {
                        ...
                        /*
                         * The date stored in Room may already contain
                         * a time component, so reset it before applying
...
private class VetDiffCallback :
    DiffUtil.ItemCallback<VetAppointmentListItem>() {

    override fun areItemsTheSame(
        oldItem: VetAppointmentListItem,
        newItem: VetAppointmentListItem
    ): Boolean {
